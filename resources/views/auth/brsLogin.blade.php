                    ...
                    <div class="row ">
                        ...
                        <div class="confirmation-col col-md-8 ">
                            ...
                            <div class="row register-form  d-flex justify-content-start">
                                <div class="form-content col-6 p-2">
                                    ...
                                    <div class="combine d-flex justify-content-evenly align-items-center">
                                        <div class="form-group col-4">
                                            <input type="number" class="form-control"  placeholder="Age" min="0" oninput="validity.valid||(value='');" required />
                                        </div>
                                ...
                                <div class="form-content col-6 p-2">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="User Name" value="" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" placeholder="User Password" value="" required/>
                                    </div>
                                </div>
